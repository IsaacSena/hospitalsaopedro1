<x-layout titulo="alterarSenhaAdm">
    ...
    <!-- Container com Aside à esquerda e imagem à direita -->
    <div class="container mt-5 pt-5 d-flex">
        <!-- Formulário à esquerda em um aside -->
        <aside class="col-md-6 col-lg-4 col-xl-3">
            <h2 class="text-center mb-4">Alterar Senha Administrador</h2>
            <form method="POST" class="shadow p-4 rounded bg-light">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" id="password" name="senhaAtual" class="form-control" placeholder="Digite sua senha atual" required>
                </div>

                <div class="mb-3">
                    <label for="newPassword" class="form-label">Nova Senha:</label>
                    <input type="password" id="newPassword" name="novaSenha" class="form-control" placeholder="Digite sua nova senha" required>
                </div>
        ...
        <!-- Imagem à direita ocupando o restante da tela -->
        <div class="col-md-6 col-lg-8 col-xl-7">
            <img src="https://www.cliquemedicos.com.br/blog/wp-content/uploads/2020/01/Cl%C3%ADnico-M%C3%A9dico-scaled.jpg" alt="Imagem" class="img-fluid w-100 h-100" style="object-fit: cover;">
        </div>
    </div>
        ...
        <div class="container-fluid p-4">
            <div class="row my-4">
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a href="/loginFuncionario" class="text-white"><i class="fas fa-paw pe-3"></i>Login</a>
                        </li>
                        <li class="mb-2">
