<x-layout titulo="cadastrarAdm">
    ...
    <div class="container mt-5 pt-5 d-flex justify-content-center">
        <div class="col-md-6 col-lg-5 col-xl-4">
            <h2 class="text-center mb-4">Criar Conta Administrador</h2>
            <form method="POST" action="/casdastrar/salvar" class="shadow p-4 rounded bg-light">
                <div class="mb-3">
                    <label for="name" class="form-label">Nome completo:</label>
                    <input type="text" id="name" name="nome" class="form-control" placeholder="Digite seu nome completo" required>
                </div>
        ...
        <div class="row my-4">
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2">
                        <a href="/consultarPaciente" class="text-white"><i class="fas fa-paw pe-3"></i>Consultas</a>
                    </li>
                </ul>
            </div>
