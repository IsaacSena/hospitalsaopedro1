<x-layout titulo="loginPaciente">
    ...
    <div class="container mt-5 pt-5 d-flex justify-content-center">
        <div class="col-md-6 col-lg-5 col-xl-4">
            <h2 class="text-center mb-4">Login Paciente</h2>
            <form method="POST" class="shadow p-4 rounded bg-light">
                ...
                <div class="mb-3">
                    <a href="/alterarSenhaPaciente" class="text-decoration-none">Esqueci minha senha</a>
                </div>
            ...
            <div class="text-center mt-3">
                <p>Não tem uma conta? <a href="/cadastrarPaciente" class="text-decoration-none">Registrar-se</a></p>
            </div>
        </div>
    </div>
    <br>
